...
fileLocation = 'crailin/'
numFiles = len(list(glob.glob('crailin/*.png')))

imageWidth, imageHeight = 968, 728
...
for i in range(1, numFiles - 1):
    ...
    r = results[0]
    masky = np.zeros((728, 968), dtype='uint8')
    if r['rois'].shape[0] >= 1:
        ...
        paster.paste(Image.fromarray(np.roll(frame, -200, axis=1)), (0,0), mask=mask)
    ...
    fileout = 'crailout/%05d.jpg' % counter
    print(fileout)
