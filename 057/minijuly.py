...
fileLocation = 'minijulyin/'
numFiles = len(list(glob.glob('minijulyin/*.png')))
...
for i in range(1, numFiles - 1):
    ...
    if r['rois'].shape[0] >= 1 and flipped:
        ...
        # paster contains blank image with just outline
        paster.paste(Image.fromarray(np.roll(frame, -450, axis=1)), (0,0), mask=mask)
    ...
    fileout = 'minijulyout/%05d.jpg' % counter
    print(fileout)
